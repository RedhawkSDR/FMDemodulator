...
void FMDemodulator_base::construct()
{
...
*******************************************************************************************/
void FMDemodulator_base::initialize() throw (CF::LifeCycle::InitializeError, CORBA::SystemException)
{
}
...
void FMDemodulator_base::start() throw (CORBA::SystemException, CF::Resource::StartError)
{
    ...
    if (serviceThread == 0) {
        ...
        serviceThread = new ProcessThread<FMDemodulator_base>(this, 0.1);
        serviceThread->start();
    }
...
CORBA::Object_ptr FMDemodulator_base::getPort(const char* _id) throw (CORBA::SystemException, CF::PortSupplier::UnknownPort)
{
