...
#ifndef FMDEMODULATOR_IMPL_BASE_H
#define FMDEMODULATOR_IMPL_BASE_H
...
class FMDemodulator_base : public Resource_impl
{
    public:
        FMDemodulator_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<FMDemodulator_base> *serviceThread; 
